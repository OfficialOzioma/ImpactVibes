...
<br>
    <div class="container">
        <div class="m-3">
            <div class="">
                <form action="/updateMentor/{{$mentor->id}}" method="post"  enctype="multipart/form-data">
                    @csrf
                            ...
                            <div class="card card-6 p-3">
                                ...
                                <div class="card-body">
                                        <div class="form-row">
                                            ...
                                            <div class="value">
                                            <input class="input--style-6 form-control-lg" value="{{$mentor->name}}" type="text" name="name" placeholder="The name of the mentor here">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-row">
                                            ...
                                            <div class="value">
                                                <div class="value">
                                                    <input class="input--style-6 form-control-lg" value="{{$mentor->email}}" type="text" name="email" placeholder="Active email address">
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-row">
                                            ...
                                            <div class="value">
                                                <input class="input--style-6 form-control-lg" value="{{$mentor->contact}}" type="integer" name="contact" placeholder="Your Whatsapp Phone Number">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-row">
                                            ...
                                            <div class="value">
                                                <input class="input--style-6 form-control-lg" value="{{$mentor->facebook}}" type="text" name="facebook" placeholder="The link to your facebook account">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-row">
                                            ...
                                            <div class="value">
                                                <input class="input--style-6 form-control-lg" value="{{$mentor->twitter}}" type="text" name="twitter" placeholder="The link to your twitter account">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-row">
                                            ...
                                            <div class="value">
                                                <input class="input--style-6 form-control-lg" value="{{$mentor->linkedin}}" type="text" name="linkedin" placeholder="The link to your linkedin account">
                                            </div>
                                        </div>
                                ...
                                <div class="card-footer">
                                    <button class="btn btn--radius-2 btn-dark" type="submit">Update Mentor</button>
                                </div>
                            </div>
                        </div>
                    </div>
