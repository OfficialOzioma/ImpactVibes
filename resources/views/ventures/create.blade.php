                            ...
                            <div class="card card-6 p-3">
                                ...
                                <div class="card-body">
                                        ...
                                        <div class="form-row">
                                            ...
                                            <div class="value">
                                                <div class="input-group ">
                                                    <input class="input-file" type="file" name="picture_of_the_startup" id="">
                                                    <input class="" type="file" name="picture_of_the_startup" id="">
                                                    <label class="label--file" for="file">Select Picture of the Startup</label>
                                                    <span class="input-file__info">No Picture Selected</span>
                                                </div>
