...
<div class="container">
    ...
    <div class="row justify-content-center">
        <div class="col-lg-12">
            <div class="section-title pb-30">
                <h6 style="margin: 5px; font-size: 22px; color:#000000" class="title mb-15">About {{$venturesDetails->startup_name}}<p style="color: #000000;"> {{$venturesDetails->about_startup}}</p></h6>
            </div> <!-- section title -->
        </div>
    </div>
